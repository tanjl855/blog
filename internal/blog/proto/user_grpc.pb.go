...
const (
	UserService_UserTest_FullMethodName = "/proto.UserService/UserTest"
)
...
type UserServiceClient interface {
	UserTest(ctx context.Context, in *User, opts ...grpc.CallOption) (*ErrRsp, error)
}
...
func (c *userServiceClient) UserTest(ctx context.Context, in *User, opts ...grpc.CallOption) (*ErrRsp, error) {
	out := new(ErrRsp)
...
type UserServiceServer interface {
	UserTest(context.Context, *User) (*ErrRsp, error)
}
...
func (UnimplementedUserServiceServer) UserTest(context.Context, *User) (*ErrRsp, error) {
...
func _UserService_UserTest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UserTest(ctx, req.(*User))
	}
